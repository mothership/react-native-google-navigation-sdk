...
export const NavigationView = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  return (
    ...
    React.createElement(GoogleNavigationView, {
      ...
      showTripProgressBar: props.showTripProgressBar === undefined ? true : props.showTripProgressBar,
      showCompassButton: props.showCompassButton === undefined ? true : props.showCompassButton,
      showTrafficLights: props.showTrafficLights === undefined ? true : props.showTrafficLights,
      showStopSigns: props.showStopSigns === undefined ? true : props.showStopSigns,
      showSpeedometer: props.showSpeedometer === undefined ? true : props.showSpeedometer,
      showSpeedLimit: props.showSpeedLimit === undefined ? true : props.showSpeedLimit
      // @ts-ignore
      ,
